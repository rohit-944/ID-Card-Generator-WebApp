            ...
            <div class="container" style="height: 200px">
                <div class="row ">
                    <div class="col-md-12 about ">
                        ...
                        <ul>
                            <li>
                                <h6>A web application for an online ID card generating system and authorized by an
                                    Educational Institute.</h6>
                            </li>
                            <li>
                                <h6>It was also managing the student's record easily.</h6>
                            </li>
                        </ul>
                    </div>
                </div>
