                        ...
                        <div class="row ">
                            <div class=" col-md-12">
                                <table class="table border">
                                    ...
                                    <tbody>
                                        <% Connection con; PreparedStatement ps; ResultSet x;
                                            Class.forName("com.mysql.jdbc.Driver");
                                            con=DriverManager.getConnection("jdbc:mysql://localhost:3306/idcard","root","");
                                            String query="select * from contact" ; Statement st=con.createStatement();
                                            x=st.executeQuery(query); while(x.next()) { String sn=x.getString("sn"); %>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="deleteC.jsp?sn=<%=sn%>" class="btn btn-danger">Delete</a>
                                                </td>
                                            </tr>
                                            <% } %>
