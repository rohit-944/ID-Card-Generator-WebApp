                            ...
                            <div class=" contact-area2">
                                ...
                                <form action="Idcard" method="POST">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="scholar" name="txtscholar"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="fname" name="txtfname"
                                    ...
                                    <div class="form-group">
                                        <label>Session</label>
                                        <input type="" class="form-control" id="session" name="txtsession"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="" class="form-control" name="txtmobile" id="mobile"
                                    ...
                                    <div class="form-group">
                                        <label>Address</label>
                                        <input type="addres" class="form-control" name="txtaddress" id="address"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <button type="register" id="submitBtn" class="btn btn-primary">Get Id
                                            Card</button>
