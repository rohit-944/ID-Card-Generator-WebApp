                                ...
                                <table class="table border">
                                    ...
                                    <tbody>
                                        <% Connection con; PreparedStatement ps; ResultSet x;
                                            ...
                                            String query="select * from regstu" ; Statement st=con.createStatement();
                                            x=st.executeQuery(query); while(x.next()) { String
                                            scholar=x.getString("scholar"); %>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="delete.jsp?scholar=<%=scholar%>"
